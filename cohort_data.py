...
def sort_by_cohort(filename):
    ...
    for line in imported_data:
        ...
        elif student[-1] == "Spring 2015":
            spring_15.append(student_name)

        elif student[-1] == "Winter 2015":
            winter_15.append(student_name)

        elif student[-1] == "Summer 2015":
            summer_15.append(student_name)

# accomplished everything but sorting because ouput was not of type "list"
 #   sorted_tas = list(tas.sort())
 #   sorted_spring = list(spring_15.sort())
 #   sorted_winter = list(winter_15.sort())
 #   sorted_summer = list(summer_15.sort())

  #  print type(sorted_tas)

    all_students = tas + spring_15 + winter_15 + summer_15
